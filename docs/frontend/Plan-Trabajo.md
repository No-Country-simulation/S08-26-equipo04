...
| HU-5.3 & 5.4: Dashboards del Gerente (Métricas de planta, cuellos de botella y gráficos/indicadores de calidad). | HU-4.3 & 2.3: Circuitos de No Conformidad (Devolución a Producción y Despacho). |
...
*QualityTrack · NO-Country 2026. Plan de Trabajo Frontend — MVP v1.0*
